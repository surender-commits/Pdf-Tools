...
title PDF Compressor - Standard Mode
...
set "IMG_DENSITY=150"        :: Density for magick when rebuilding PDF
set "IMG_RESIZE=50%%"        :: Resize percentage for magick (e.g., 75%%)
...
set "Input=%~1"
set "Final_Pdf=%~dp1%~n1_Compressed_Standard.pdf"
md "%Work_Dir%" >nul 2>&1
